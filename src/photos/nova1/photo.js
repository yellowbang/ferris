...
export default [
    ...
    {
        src: chair_200,
        descr: '之所倚拣这张相，纯粹系为了hight light 衣张$200蚊的凳。。醒目啊，识得喇少少💩系张凳上。你妈妈想退都退唔到。',
    },
    {
        src: sleep_jojo,
        descr: '每次见到你同妈妈好安逸甘睡觉的时候，我就觉得好幸福。好想你地每日都安稳的生活。到你长大成家立业的时候都要好好保护你的家人啊。也许到时候你就体会到我现在的心情。',
    },
    {
        src: butterfly,
        descr: '纯熟恶搞，你爸爸妈妈都有类似的相嘎。唔知你会唔会第日都系一个有趣而且搞笑的人呢。',
    },
    {
        src: zoo,
        descr: '爸爸妈妈同你第一次去动物园睇灯饰。见到闪闪发光的野，中唔中意啊？',
    },
    {
        src: yellow,
